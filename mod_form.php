...
/**
 * The main onedriveoffice configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_onedriveoffice_mod_form extends moodleform_mod {
    ...
    public function definition() {
	 ...
	 $get_app_id = get_config('mod_onedriveoffice','clientid');
	 ...
	 $str_bun = get_string( 'onedriveofficename' , 'onedriveoffice');
        ...
        $mform->addHelpButton('name', 'onedriveofficename', 'onedriveoffice');
        ...
        $mform->addElement('header', 'onedrive_share', get_string('onedrive_share','onedriveoffice'));
        $mform->setExpanded('onedrive_share',true);


        // Adding the rest of onedriveoffice settings, spreading all them into this fieldset
        // ... or adding more fieldsets ('header' elements) if needed for better logic.
	 $str_bun = get_string( 'onedrive_share_setumei' , 'onedriveoffice');
	 ...
	 $str_bun = get_string( 'onedrive_share_filename' , 'onedriveoffice');
	 $str_bun_2 = get_string( 'onedrive_share_group' , 'onedriveoffice');
	 ...
	 $str_bun = get_string( 'onedrive_view' , 'onedriveoffice');
        $mform->addElement('header', 'onedrive_view', $str_bun);
        $mform->setExpanded('onedrive_view',true);

	 $str_bun = get_string( 'onedrive_view_setumei' , 'onedriveoffice');
        $mform -> addElement ( 'html' , "<table><tr><td width=800px><b>$str_bun</b></td><td>");	 
	 $mform -> addElement ( 'html' , '<div class="row">');
	 $mform -> addElement ( 'html' ,'<input id="downloadLink" type="hidden" value="download" name="actionType" checked="checked"> ');
	 $mform -> addElement ( 'html' , '</div>');
	 ...
	 $str_bun = get_string( 'onedrive_view_filename' , 'onedriveoffice');
...
//	 $mform -> addElement ( 'html' ,'var list = document.getElementById("list");');
	 ...
	 $str_bun = get_string( 'select_group' , 'onedriveoffice');
...
');
	 $mform -> addElement ( 'html' ,"url: '/moodle/mod/onedriveoffice/read.php',
");
