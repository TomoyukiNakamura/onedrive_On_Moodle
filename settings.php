...
if ($ADMIN->fulltree) {
	...
	$settings->add(new admin_setting_heading('mod_onedriveoffice/view_administration',get_string('setting_head','onedriveoffice'),''));
	$str_url ='';
	$str_lang = get_string( 'setting_lang' , 'onedriveoffice');
	if($str_lang == 'ja'){
	...
	$settings->add(new admin_setting_configtext('mod_onedriveoffice/clientid','clientID', get_string('setting_setumei','onedriveoffice')."
